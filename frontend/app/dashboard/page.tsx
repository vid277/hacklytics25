    ...
    <div className="flex-1 flex flex-col gap-6 p-4 md:p-8">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <h2 className="text-2xl font-medium font-oddlini mb-4">Your Uploads</h2>
        ...
        {/* Lending Jobs Section */}
        <div className="bg-white rounded-lg shadow p-6">
          <h2 className="text-2xl font-medium font-oddlini mb-4">Your Lending</h2>
          {lendingJobs.length > 0 ? (
            ...
            <p className="text-muted-foreground font-hanken">No lending activity yet</p>
          )}
        </div>
      </div>
    </div>
